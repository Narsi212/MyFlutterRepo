...
class _ChatWindow extends State<ChatWindow> {
  ...
  void initState() {
    ...
    timer = Timer.periodic(Duration(seconds: 1), (Timer timer) async {
      var activeUsersRes = await http.read("http://165.22.14.77:8080/Narsi/ChatRoom/activeUsers.jsp?username=" + username);
      var messagesRes = await http.read("http://165.22.14.77:8080/Narsi/ChatRoom/showMessages.jsp?username=" + username);
      setState(() {
  ...
  _sendMessage() async {
    var sendStatus = await http.read("http://165.22.14.77:8080/Narsi/ChatRoom/sendMessage.jsp?username=" + username + "&message=" + txtMessage.text);
    txtMessage.text = '';
  }
